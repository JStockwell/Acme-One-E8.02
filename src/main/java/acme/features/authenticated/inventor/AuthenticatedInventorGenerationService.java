...
@Service
public class AuthenticatedInventorGenerationService implements AbstractCreateService<Authenticated, Inventor> {

	// Internal state ---------------------------------------------------------

	@Autowired
	protected AuthenticatedInventorRepository repo;
	...
	@Override
	public void unbind(final Request<Inventor> request, final Inventor inventor, final Model model) {
		assert request != null;
