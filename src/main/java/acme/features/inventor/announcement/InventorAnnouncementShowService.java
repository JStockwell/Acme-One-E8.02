...
@Service
public class InventorAnnouncementShowService implements AbstractListService<Inventor,Announcement>{
	...
	@Override 
	public Collection<Announcement> findOne(final Request<Announcement> request){
		assert request !=null;
